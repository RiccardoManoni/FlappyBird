...
class GameOverState: GKState {
    ...
    func showScoreCard() {
        ...
        gameOver.position = CGPoint(x: scene.size.width / 2,
                                    y: scene.size.height / 2 + scoreCard.size.height / 2 + scene.margin + gameOver.size.height / 2)
        ...
        shareButton.position = CGPoint(x: scene.size.width * 0.75,
                                    y: scene.size.height / 2 - scoreCard.size.height / 2 - scene.margin - shareButton.size.height / 2)
